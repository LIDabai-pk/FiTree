...
public class WaterView extends FrameLayout {
    ...
    private int mTotalConsumeWater;//all clicked drop
        ...
        for (int i = 0; i < waters.size(); i++) {
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    sum.setText("Sum:" + String.valueOf(mTotalConsumeWater));
                    SPUtils.put(getContext(), Constant.sp_sum,mTotalConsumeWater);
                }
            });
            //随机设置view动画的方向
    ...
    private void handViewClick(View view) {
        ...
        if (tag instanceof Water) {
            ...
            Toast.makeText(getContext(), "You get:"
                    + waterTag.getNumber() + "\nTotal Energy is" + mTotalConsumeWater, Toast.LENGTH_SHORT).show();
        }
    ...
    public int getmTotalConsumeWater(){
        return mTotalConsumeWater;
    }

    public void setmTotalConsumeWater(int _mTotalConsumeWater){
        mTotalConsumeWater = _mTotalConsumeWater;
    }
}
